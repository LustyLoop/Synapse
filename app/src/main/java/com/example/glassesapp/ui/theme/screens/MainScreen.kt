...
import com.example.glassesapp.ui.theme.AIMessageBackgroundColor
...
fun SharedScreen(
    ...
    var shaderBackground = remember { DarkShaderBackground }
    ...
    var ballShader = remember { ballShader }
    var time by remember { mutableFloatStateOf(0f) }
    val rand = remember { Random.nextFloat() }
    val keyboardController = LocalSoftwareKeyboardController.current

    shaderBackground =
        if (isSystemInDarkTheme()) DarkShaderBackground
        else LightShaderBackground
    ...
    Box(
            ...
            .then(
                if(Shaders.currentShader == AllShaders.Wave) {
                    Modifier.drawWithCache {
                        ...
                        shaderBackground.setFloatUniform("hideAndShowProgress", hideAndShowProgress)
                        onDrawBehind {
                            shaderBackground.setFloatUniform("time", time)
                            drawRect(brush = ShaderBrush(shaderBackground))
                        }
                    }
                }
                else{
                    Modifier.drawWithCache {
                        ...
                        onDrawBehind {
                            ...
                            drawRect(brush = ShaderBrush(ballShader))
                        }
                    }
                }
        ...
        /*-----------------------------------------------------------------------------*/
        Button(
            onClick = {gadget.batteryCharge += 1 },
            modifier = Modifier
            ...
            LazyColumn(
                ...
                items(
                    ...
                    Box(
                        ...
                        when (userChatMessages.userAndAiMessages.lastOrNull()?.role) {
                            IdentifyRole.USER -> {
                                Box(
                                    modifier = Modifier
            ...
            Row(
                ...
                Button(
                    onClick = {
                        ...
                        userChatMessages.chatHandler(userChatMessages, navController)
                    },
                    modifier = Modifier
                        .size(35.dp),
                    contentPadding = PaddingValues(0.dp),
